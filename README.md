...
* `tidy_data.txt` -  a tidy data set (long form) that was created by executing `run_analysis.R`; it contains the average of each variable for each activity and each subject
